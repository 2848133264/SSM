...
<%
	if (session.getAttribute("admin") == null)
		response.sendRedirect("/SSM/admin_login.jsp");
		request.setAttribute("currentTime", new SimpleDateFormat("yyyy年MM月dd日 hh时mm分").format( new Date()));
%>
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height: 70px; background: rgba(103, 164, 248, 0.52); padding: 10px">
		<div align="left">
			<div style="font-family: Microsoft YaHei; font-size: 20px;" align="center">电商后台管理系统 </div>
		
		</div>
		<div align="right" style="font-size: 16px">
			<span style="float: left;margin-left: -10px;font-size: 14px;">当前时间 ${currentTime}</span>	欢迎您，<font color="Red">${sessionScope.admin.name}</font>
		</div>
	</div>
	...
	<div data-options="region:'south',border:false"
		style="height: 50px; background: rgb(224, 236, 255); padding: 10px; text-align: center">S S M</div>
