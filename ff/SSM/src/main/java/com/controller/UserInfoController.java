...
public class UserInfoController {
	...
	public Map<String, Object> userlist(Integer page, Integer rows, UserInfo userInfo) {
		...
		for (UserInfo userInfo2 : userinfos) {
			System.out.println("userInfo2  "+userInfo2.getId() + ",");
		}
	...
	@ResponseBody
	public String deleteUser(@RequestParam(value = "id") String id) {//捆绑参数
		System.out.println("id = " +id);
		try {
			userInfoService.deleteUser(Integer.parseInt(id));
