...
<body>
	...
	<div id="tb_productinfo" style="padding: 2px 5px;">
	  ...
	  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="removeProduct();" >下架</a>
	  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-no" plain="true" onclick="deleteProduct();" >删除</a>
	</div>
	...
	<div id="searchtb_productinfo" style="padding: 2px 5px;">
		<form id="searchForm_productinfo" method="post">
			...
			商品编号&nbsp;&nbsp;
			<input class="easyui-textbox" name="productinfo_search_code" id="productinfo_search_code" style="width: 110px" /> </div>
			<div style="padding: 3px">
		       商品名称&nbsp;&nbsp;<input class="easyui-textbox" name="productinfo_search_name" id="productinfo_search_name"
			style="width: 110px" /> &nbsp;&nbsp;
			商品类型&nbsp;&nbsp;<input style="width: 110px;" id="productinfo_search_tid"
			class="easyui-combobox" name="productinfo_search_tid" data-options="valueField:'id',textField:'name',url:'type/getType/1'" value="0">&nbsp;&nbsp; 
			商品品牌&nbsp;&nbsp;<input class="easyui-textbox" name="productinfo_search_brand" id="productinfo_search_brand" style="width: 110px" />&nbsp;&nbsp;
			价格: <input class="easyui-numberbox" name="productinfo_search_priceFrom" id="productinfo_search_priceFrom" style="width: 80px;" /> ~ <input
	...
	<script type="text/javascript">
		$(function() {
			$('#dg_productinfo').datagrid({
				...
				url : 'productinfo/list', 	//为datagrid设置数据源 ,发送请求，到这个productinfo 下的 list ;
				pagination : true, 			//启用分页
				pageSize : 6, 				//设置初始每页记录数（页大小）
				pageList : [ 6, 12, 20 ], 	//设置可供选择的页大小
		...
		function removeProduct() {
			...
			if (rows.length > 0) {
				$.messager.confirm('Confirm', '确认要下架该商品吗?', function(r) {
					if (r) {
						var ids = "";
						for (var i = 0; i < rows.length; i++) {
							ids += rows[i].id + ",";
						}
						$.post('productinfo/downProduct', {///
							id : ids,
							flag : 0
						}, function(result) {
