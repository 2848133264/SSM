...
<body>
	...
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-no" onclick="deleteUser();" plain="true">删除客户</a>
	</div>
	...
	<script type="text/javascript">
		...
		//删除用户
		function deleteUser() {
			var row = $("#userListDg").datagrid('getSelections');
			if (row.length > 0) {
		...
		function SetIsEnableUser(flag) {
			...
			if (rows.length > 0) {
				$.messager.confirm('提示', '确认要设置吗?', function(r) {
					if (r) {
						var uids = "";
